...
export class ChatRoomPage {
  ...
  http.post('https://damp-fjord-22544.herokuapp.com/api/ChatGetMessages/', load)
...
sendMessage() {
  ...
  this.http.post('https://damp-fjord-22544.herokuapp.com/api/ChatSendMessage/', chat)
  ...
  this.http.post('https://damp-fjord-22544.herokuapp.com/api/ChatGetPlayerDetails/', player)
